...
(after! clojure-mode
  ...
  (add-hook! 'clojure-mode-hook (setq fill-column 90))

  ;; My attempt at stopping the automatic removal of manually added indent, i.e.
  ;; typing space, then text, removed the space before (in docstrings).
  (add-hook! 'clojure-mode-hook (setq electric-indent-inhibit t))
